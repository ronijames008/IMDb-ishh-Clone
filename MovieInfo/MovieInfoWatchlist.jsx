...
function Watchlist() {
  ...
  useEffect(() => {
    axios
      .get(
        "https://api.themoviedb.org/3/genre/movie/list?api_key=bff2b86ea037d99d01532d860b4d4924&language=en",
      )
      .then((result) => {
        setGenres(
                    ...
                    >
                      <td className="p-2 sm:p-3 md:p-4">
                        <div className="flex items-center space-x-3 sm:space-x-4 md:space-x-6">
                          <div
                            className="h-12 w-20 flex-shrink-0 cursor-pointer rounded bg-cover bg-center sm:h-16 sm:w-24 md:h-20 md:w-32 lg:h-24 lg:w-40"
                            style={{
                          ...
                          ></div>
                          <span
                            className="cursor-pointer text-xs font-medium hover:text-[#F5C518] sm:text-sm md:text-base lg:text-lg"
                            onClick={() => navigate(`/movie/${movieObj.id}`)}
                          >
                            {movieObj.title}
                          </span>
                      ...
                      <td className="p-2 sm:p-3 md:p-4">
                        <div className="flex items-center justify-between">
                          <span>{genres[movieObj.genre_ids[0]]}</span>
                          <button
                            onClick={() => {
